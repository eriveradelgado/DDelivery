...
# Independently the scientist will end up with multiple files. In our case the 
# output of the h1 reader were excel files. The following workflow is a set of
